class AttendanceRecordsController < ApplicationController
  ...
  private
    ...
    def attendance_record_params
      params.require(:attendance_record).permit(:demo_staff_member_id, :start_of_week, :monday_store, :tuesday_store, :wednesday_store, :thursday_store, :friday__store, :saturday_store, :sunday_store)
    end
end
